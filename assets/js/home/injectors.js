const injectEmployees = (employees) => employees.map(({name, field, image, links}, index) => $("#team-section-list").append(`
...
<div class="wow fadeInUp"  data-wow-delay="400ms" data-wow-duration="1200ms">
        <div class="bi-team-item-2 text-center">
            ...
            <div class="bi-team-social ul-li">
                ${links ? `<ul>
                    ${links.instagram ? `<li><a href="${links.instagram}" target="_blank"> <i class="fab fa-instagram"/></a></li>` : ''}
                    ${links.linkedin ? `<li><a href="${links.linkedin}" target="_blank"> <i class="fab fa-linkedin-in"/></a></li>` : ''}
                    ${links.Facebook ? `<li><a href="${links.Facebook}" target="_blank"> <i class="fab fa-facebook"/></a></li>` : ''}
                    ${links.youtube ? `<li><a href="${links.youtube}" target="_blank"> <i class="fab fa-youtube"/></a></li>` : ''}
                </ul>` : ''}
            </div>
        </div>
    </div>
